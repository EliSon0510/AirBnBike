...
puts "Feeding the database.. please wait.."
 ...
 p Bike.create!(category: 'e-bike', description: 'you can go really fast', price:40, user: user_1)
 p Bike.create!(category: 'mountain bike', description: 'used in the mountains not in a city', price:30, user: user_2)
